...
def invoke_dif(ensemble_size: int):
    dataset_root = 'data'
    ...
    #model_configs['n_ensemble'] = ensemble_size
    ...
    for f in data_lst:
        ...
        args.runs = 1   #newly added by fauhat on 1st September Friday
        ...
        print(txt)
        f.close()
        run_time.append(avg_time)
        #run_time[time_index] = avg_time
